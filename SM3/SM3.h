...
#define SM3_len 256 
//常量Tj
#define SM3_T1 0x79CC4519   //0≤j≤15
#define SM3_T2 0x7A879D8A   //16≤j≤63
//初始值IV
...
//置换函数
#define SM3_p1(x)        (x^SM3_rotl32(x,15)^SM3_rotl32(x,23)) //P1(X)
#define SM3_p0(x)        (x^SM3_rotl32(x,9)^SM3_rotl32(x,17)) //P0(X)
//布尔函数
#define SM3_ff0(a,b,c)   (a^b^c)  //0≤j≤15
#define SM3_ff1(a,b,c)   ((a&b)|(a&c)|(b&c)) //16≤j≤63
#define SM3_gg0(e,f,g)   (e^f^g) //0≤j≤15
#define SM3_gg1(e,f,g)   ((e&f)|((~e)&g)) //16≤j≤63
//
